                    ...
                    <div class="p-4 sm:p-8 bg-gradient-to-r from-[#001834] to-[#0d3b5a] text-white">
                        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
                            <div class="flex items-center gap-4 sm:gap-5 w-full sm:w-auto">
                                ...
                                <div class="min-w-0 flex-1">
                                    <div class="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
                                        <h2 class="text-xl sm:text-2xl font-black tracking-tight truncate uppercase" x-text="selectedEmpresa.razsoem"></h2>
                                        <span class="w-fit bg-emerald-500/20 text-emerald-300 text-[9px] sm:text-[10px] font-black px-3 py-1 rounded-full border border-emerald-500/30 uppercase tracking-widest">Activo Fiscal</span>
                                    </div>
                                    <p class="text-white/60 text-[10px] sm:text-xs font-medium mt-1 flex flex-wrap items-center gap-x-3 gap-y-1">
                                        ...
                                        <span class="flex items-center gap-1.5">
                                            ...
                                            <span class="truncate max-w-[150px] sm:max-w-none" x-text="'Gerente: ' + selectedEmpresa.nomger"></span>
                                        </span>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-2 w-full sm:w-auto pt-2 sm:pt-0">
                                <button @click="openEdit(selectedEmpresa)" class="flex-1 sm:flex-none bg-white/10 hover:bg-white/20 text-white px-5 py-3 rounded-xl font-bold text-[10px] sm:text-xs uppercase tracking-widest transition-all border border-white/10">
                                    Editar Empresa
                                </button>
