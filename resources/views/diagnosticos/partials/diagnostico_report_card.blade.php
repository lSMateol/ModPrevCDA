{{--
    Partial: diagnostico_report_card.blade.php
    Renderiza el contenido completo (encabezado, tablas, resultados, firmas, fotos,
    y bloque de reinspección condicional) de un único diagnóstico.

    Variables requeridas:
      $diagnostico  — instancia del modelo Diagnostico con sus relaciones cargadas

    Este partial es incluido por:
