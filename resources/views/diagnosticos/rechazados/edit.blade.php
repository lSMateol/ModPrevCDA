...
<div class="px-8 py-6 space-y-8 max-w-4xl mx-auto">
    ...
    <div class="flex justify-between items-end">
        <div>
            <h1 class="font-headline font-black text-3xl text-[#001834] tracking-tight">Editar Registro de Inspección</h1>
        ...
        <div class="flex gap-4">
            <a href="{{ route($prefix . '.rechazados') }}" class="px-6 py-3 rounded-xl border border-gray-200 font-bold text-xs uppercase tracking-widest text-gray-500 hover:bg-gray-50 transition-all">Cancelar</a>
            <button form="editRechazoForm" type="submit" class="bg-[#001834] text-white px-8 py-3 rounded-xl font-bold text-xs uppercase tracking-widest shadow-xl shadow-[#001834]/10 hover:bg-[#002d54] transition-all flex items-center gap-2">
    ...
    <form id="editRechazoForm" action="{{ route($prefix . '.rechazados.update', $diagnostico->iddia) }}" method="POST" class="space-y-8">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm space-y-6">
            ...
            <div class="space-y-2">
                <label class="text-[10px] font-black uppercase tracking-widest text-gray-400 ml-1">Observaciones Adicionales del Inspector</label>
