    ...
    <nav class="flex-1 overflow-y-auto py-4 custom-scrollbar">
        <div class="px-4 space-y-1">
            ...
            <div class="space-y-1">
                ...
                <div x-show="openMenu === 'entidades'" x-collapse class="ml-5 pl-4 border-l border-gray-700/50 space-y-1 mt-1 bg-[#0f2a4a]/50 rounded-r-md relative">
                    <a href="{{ route('admin.dashboard') }}" class="relative flex items-center py-2 text-[10px] text-gray-400 hover:text-white transition">
                        <span class="absolute -left-4 w-3 h-px bg-gray-700/50"></span>
