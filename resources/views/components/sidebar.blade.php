        ...
        <div class="px-4 space-y-2">
            ...
            <div class="space-y-1">
                <a href="{{ route('profile.edit') }}" 
                   class="sidebar-item w-full flex items-center py-3 px-3 rounded-xl group transition-all duration-200 {{ Request::routeIs('profile.edit') ? 'bg-white/5 text-white' : 'hover:bg-white/[0.03] hover:text-white' }}">
                    <div class="flex items-center gap-4 min-w-0">
                        <iconify-icon icon="lucide:building" class="text-xl shrink-0 transition-transform group-hover:scale-110 {{ Request::routeIs('profile.edit') ? 'text-blue-400' : 'text-slate-500' }}"></iconify-icon>
            ...
            <div class="space-y-1 pt-6 mt-6 border-t border-white/5">
                ...
                <div x-show="(openMenu === 'config') && (!sidebarCollapsed || mobileMenuOpen)" x-collapse class="space-y-1 mt-1">
                    <a href="{{ route('admin.catalogos.index', ['tab' => 'parametros']) }}" class="flex items-center gap-3 py-2.5 px-10 text-[10px] font-bold uppercase tracking-widest transition group {{ Request::routeIs('admin.catalogos.index') && request('tab') == 'parametros' ? 'text-white' : 'text-slate-500 hover:text-white' }}">
                        <div class="w-1.5 h-1.5 rounded-full transition-colors {{ Request::routeIs('admin.catalogos.index') && request('tab') == 'parametros' ? 'bg-blue-400' : 'bg-slate-700 group-hover:bg-blue-400' }}"></div>
                        Tipo Parámetro
                    </a>
                    <a href="{{ route('admin.catalogos.index', ['tab' => 'parametros']) }}" class="flex items-center gap-3 py-2.5 px-10 text-[10px] font-bold uppercase tracking-widest transition group {{ Request::routeIs('admin.catalogos.index') && request('tab') == 'parametros' ? 'text-white' : 'text-slate-500 hover:text-white' }}">
                        <div class="w-1.5 h-1.5 rounded-full transition-colors {{ Request::routeIs('admin.catalogos.index') && request('tab') == 'parametros' ? 'bg-blue-400' : 'bg-slate-700 group-hover:bg-blue-400' }}"></div>
                    ...
                    <a href="{{ route('admin.catalogos.index', ['tab' => 'dominios']) }}" class="flex items-center gap-3 py-2.5 px-10 text-[10px] font-bold uppercase tracking-widest transition group {{ Request::routeIs('admin.catalogos.index') && request('tab') == 'dominios' ? 'text-white' : 'text-slate-500 hover:text-white' }}">
                        <div class="w-1.5 h-1.5 rounded-full transition-colors {{ Request::routeIs('admin.catalogos.index') && request('tab') == 'dominios' ? 'bg-blue-400' : 'bg-slate-700 group-hover:bg-blue-400' }}"></div>
                        Dominio
                    </a>
                    <a href="{{ route('admin.catalogos.index', ['tab' => 'dominios']) }}" class="flex items-center gap-3 py-2.5 px-10 text-[10px] font-bold uppercase tracking-widest transition group {{ Request::routeIs('admin.catalogos.index') && request('tab') == 'dominios' ? 'text-white' : 'text-slate-500 hover:text-white' }}">
                        <div class="w-1.5 h-1.5 rounded-full transition-colors {{ Request::routeIs('admin.catalogos.index') && request('tab') == 'dominios' ? 'bg-blue-400' : 'bg-slate-700 group-hover:bg-blue-400' }}"></div>
