...
<head>
    ...
    <title>CDA Rastrillantas - Registro</title>
    <script src="https://cdn.tailwindcss.com?plugins=forms,container-queries"></script>
    <link href="https://fonts.googleapis.com/css2?family=Manrope:wght@400;700;800&family=Inter:wght@400;500;600&display=swap" rel="stylesheet"/>
    <link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:wght,FILL@100..700,0..1&display=swap" rel="stylesheet"/>
    <script id="tailwind-config">
        tailwind.config = { darkMode: "class", theme: { extend: { "colors": { "inverse-surface": "#2d3133", "error-container": "#ffdad6", "inverse-primary": "#ffba20", "surface-bright": "#f7fafc", "on-surface-variant": "#43474e", "secondary": "#3f608a", "on-secondary": "#ffffff", "on-tertiary-fixed-variant": "#124782", "on-primary-container": "#c08a00", "surface-container-lowest": "#ffffff", "on-primary": "#ffffff", "surface-container": "#ebeef0", "on-tertiary-fixed": "#001c3b", "surface-tint": "#7c5800", "surface-dim": "#d7dadc", "on-primary-fixed-variant": "#5e4200", "error": "#ba1a1a", "surface-container-high": "#e5e9eb", "tertiary-fixed": "#d5e3ff", "tertiary-fixed-dim": "#a7c8ff", "on-primary-fixed": "#271900", "outline": "#73777f", "tertiary-container": "#002c59", "secondary-fixed": "#d3e4ff", "primary-container": "#3c2900", "secondary-container": "#adcefe", "on-error": "#ffffff", "on-background": "#181c1e", "primary": "#221500", "inverse-on-surface": "#eef1f3", "primary-fixed": "#ffdea8", "on-secondary-fixed-variant": "#254870", "on-tertiary": "#ffffff", "secondary-fixed-dim": "#a7c9f8", "on-secondary-fixed": "#001c38", "on-surface": "#181c1e", "primary-fixed-dim": "#ffba20", "on-secondary-container": "#365881", "surface-variant": "#e0e3e5", "on-tertiary-container": "#6b95d4", "surface": "#f7fafc", "background": "#f7fafc", "outline-variant": "#c3c6cf", "surface-container-low": "#f1f4f6", "tertiary": "#001834", "on-error-container": "#93000a", "surface-container-highest": "#e0e3e5" }, "borderRadius": { "DEFAULT": "0.125rem", "lg": "0.25rem", "xl": "0.5rem", "full": "0.75rem" }, "fontFamily": { "headline": ["Manrope"], "body": ["Inter"], "label": ["Inter"] } }, }, }
    </script>
    <style>
    ...
    <main class="flex-grow flex flex-col relative overflow-hidden">
        ...
        <div class="relative z-10 w-full max-w-md mx-auto px-6 pt-12 pb-8 flex flex-col items-center justify-center min-h-[calc(100vh-128px)]">
            ...
            <div class="w-full mb-8 text-left">
                <h1 class="font-headline text-4xl font-extrabold text-tertiary mb-2 tracking-tight">Registro</h1>
                <p class="font-body text-on-surface-variant text-sm tracking-wide">Crea una cuenta en el sistema preventivo.</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}" class="w-full space-y-6">
                ...
                <!-- Input Group: Nombre -->
                <div class="space-y-2">
                    <label class="font-label text-[0.75rem] uppercase tracking-[0.05em] font-semibold text-on-surface-variant px-1">Nombre</label>
                    <div class="relative group">
                        <input name="name" value="{{ old('name') }}" type="text" required autofocus autocomplete="name" class="w-full bg-surface-container-high border-b border-outline-variant border-opacity-20 py-3 px-4 font-body text-on-surface focus:outline-none focus:border-primary-fixed-dim transition-colors duration-300 rounded-lg" placeholder="Tu Nombre Completo"/>
                    </div>
                    @error('name')
                ...
                <!-- Input Group: Correo -->
                <div class="space-y-2">
                    <label class="font-label text-[0.75rem] uppercase tracking-[0.05em] font-semibold text-on-surface-variant px-1">Correo Electrónico</label>
                    <div class="relative group">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        <input name="password" type="password" required autocomplete="new-password" class="w-full bg-surface-container-high border-b border-outline-variant border-opacity-20 py-3 px-4 font-body text-on-surface focus:outline-none focus:border-primary-fixed-dim transition-colors duration-300 rounded-lg" placeholder="••••••••"/>
                    </div>
                    @error('password')
                    <div class="flex items-center gap-2 mt-2 px-1">
                        <span class="material-symbols-outlined text-error text-[18px]">error</span>
                ...
                <!-- Input Group: Confirmar Contraseña -->
                <div class="space-y-2">
                    <label class="font-label text-[0.75rem] uppercase tracking-[0.05em] font-semibold text-on-surface-variant px-1">Confirmar Contraseña</label>
                    <div class="relative group">
                        <input name="password_confirmation" type="password" required autocomplete="new-password" class="w-full bg-surface-container-high border-b border-outline-variant border-opacity-20 py-3 px-4 font-body text-on-surface focus:outline-none focus:border-primary-fixed-dim transition-colors duration-300 rounded-lg" placeholder="••••••••"/>
                    </div>
                ...
                <div class="pt-4">
                    <button type="submit" class="w-full py-4 bg-primary-fixed-dim hover:opacity-90 transition-all duration-150 transform active:scale-[0.98] rounded-lg shadow-[0_24px_40px_rgba(24,28,30,0.06)] flex items-center justify-center gap-2">
                        <span class="font-label text-sm uppercase tracking-[0.1em] font-bold text-on-primary-fixed">Registrarse</span>
                        <span class="material-symbols-outlined text-on-primary-fixed text-lg">person_add</span>
                    </button>
                </div>

                <!-- Secondary Link -->
                <div class="text-center">
                    <a href="{{ route('login') }}" class="font-label text-xs uppercase tracking-wider text-secondary font-semibold hover:text-primary-fixed-dim transition-colors duration-300">
